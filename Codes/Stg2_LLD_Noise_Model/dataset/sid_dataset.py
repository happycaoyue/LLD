...
class SIDDataset(BaseDataset):
    ...
    def __getitem__(self, i):
        ...
        dic =  {'input': input, 'target': target, 'fn': input_fn, 'cfa': self.cfa, 'rawpath': target_path, 'ratio': ratio}
...
class ELDEvalDataset(BaseDataset):
    ...
    def __getitem__(self, i):
        ...
        data = {'input': input, 'target': target, 'fn':input_path,'input_path': input_path,  'rawpath': target_path, 'ISO': iso}
